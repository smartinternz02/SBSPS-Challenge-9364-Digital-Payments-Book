...
app.config['MYSQL_PASSWORD'] = "Ibm@1234"
app.config['MYSQL_DB'] = "rocky"
app.config['MAIL_SERVER'] = 'smtp.gmail.com'
app.config['MAIL_PORT'] = 465
app.config['MAIL_USERNAME'] = 'paymentbook.ad@gmail.com'
app.config['MAIL_PASSWORD'] = '89199322918'
...
if __name__ == '__main__':
    app.run(port="3006", host="127.0.0.1")